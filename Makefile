...
DOCKER_REGISTRY ?= ghcr.io/sambetts-cisco
...
cli: ## Build CLI
	@(echo "Building CLI ..." )
	@(cd cli && CGO_ENABLED=0 go build -ldflags "-X github.com/sambetts-cisco/kubeclarity/cli/v2/pkg.GitRevision=${VERSION}" -o bin/cli ./main.go && ls -l bin/)
