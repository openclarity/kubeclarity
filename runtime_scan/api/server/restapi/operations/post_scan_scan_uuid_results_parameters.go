...
// PostScanScanUUIDResultsParams contains all the bound params for the post scan scan UUID results operation
...
func (o *PostScanScanUUIDResultsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ImageVulnerabilityScan
...
func (o *PostScanScanUUIDResultsParams) bindScanUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostScanScanUUIDResultsParams) validateScanUUID(formats strfmt.Registry) error {
