...
import (
	...
	runtime_scan_models "github.com/sambetts-cisco/kubeclarity/runtime_scan/api/v2/server/models"
	"github.com/sambetts-cisco/kubeclarity/runtime_scan/api/v2/server/restapi/operations"
	_config "github.com/sambetts-cisco/kubeclarity/runtime_scan/v2/pkg/config"
	"github.com/sambetts-cisco/kubeclarity/runtime_scan/v2/pkg/rest"
	_scanner "github.com/sambetts-cisco/kubeclarity/runtime_scan/v2/pkg/scanner"
	"github.com/sambetts-cisco/kubeclarity/runtime_scan/v2/pkg/types"
)
...
//go:generate $GOPATH/bin/mockgen -destination=./mock_orchestrator.go -package=orchestrator github.com/sambetts-cisco/kubeclarity/runtime_scan/v2/pkg/orchestrator VulnerabilitiesScanner
