...
// NewPutRuntimeScanStartParamsWithTimeout creates a new PutRuntimeScanStartParams object
...
// NewPutRuntimeScanStartParamsWithContext creates a new PutRuntimeScanStartParams object
...
// NewPutRuntimeScanStartParamsWithHTTPClient creates a new PutRuntimeScanStartParams object
...
func (o *PutRuntimeScanStartParams) WithDefaults() *PutRuntimeScanStartParams {
	o.SetDefaults()
	return o
}
...
func (o *PutRuntimeScanStartParams) WithTimeout(timeout time.Duration) *PutRuntimeScanStartParams {
...
func (o *PutRuntimeScanStartParams) WithContext(ctx context.Context) *PutRuntimeScanStartParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PutRuntimeScanStartParams) WithBody(body *models.RuntimeScanConfig) *PutRuntimeScanStartParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put runtime scan start params
func (o *PutRuntimeScanStartParams) SetBody(body *models.RuntimeScanConfig) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *PutRuntimeScanStartParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
