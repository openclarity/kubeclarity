...
func NewPutRuntimeQuickscanConfigParams() *PutRuntimeQuickscanConfigParams {
	return &PutRuntimeQuickscanConfigParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPutRuntimeQuickscanConfigParamsWithTimeout creates a new PutRuntimeQuickscanConfigParams object
...
// NewPutRuntimeQuickscanConfigParamsWithContext creates a new PutRuntimeQuickscanConfigParams object
...
// NewPutRuntimeQuickscanConfigParamsWithHTTPClient creates a new PutRuntimeQuickscanConfigParams object
...
func (o *PutRuntimeQuickscanConfigParams) WithDefaults() *PutRuntimeQuickscanConfigParams {
	o.SetDefaults()
	return o
}
...
func (o *PutRuntimeQuickscanConfigParams) WithTimeout(timeout time.Duration) *PutRuntimeQuickscanConfigParams {
...
func (o *PutRuntimeQuickscanConfigParams) WithContext(ctx context.Context) *PutRuntimeQuickscanConfigParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PutRuntimeQuickscanConfigParams) WithHTTPClient(client *http.Client) *PutRuntimeQuickscanConfigParams {
...
func (o *PutRuntimeQuickscanConfigParams) WithBody(body *models.RuntimeQuickScanConfig) *PutRuntimeQuickscanConfigParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put runtime quickscan config params
func (o *PutRuntimeQuickscanConfigParams) SetBody(body *models.RuntimeQuickScanConfig) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *PutRuntimeQuickscanConfigParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
