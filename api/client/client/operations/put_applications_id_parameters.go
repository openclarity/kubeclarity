...
func (o *PutApplicationsIDParams) WithDefaults() *PutApplicationsIDParams {
	o.SetDefaults()
	return o
}
...
func (o *PutApplicationsIDParams) WithBody(body *models.ApplicationInfo) *PutApplicationsIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put applications ID params
func (o *PutApplicationsIDParams) SetBody(body *models.ApplicationInfo) {
	o.Body = body
}
