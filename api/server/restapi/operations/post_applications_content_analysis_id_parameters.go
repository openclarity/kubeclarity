...
// PostApplicationsContentAnalysisIDParams contains all the bound params for the post applications content analysis ID operation
...
func (o *PostApplicationsContentAnalysisIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ApplicationContentAnalysis
...
func (o *PostApplicationsContentAnalysisIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
