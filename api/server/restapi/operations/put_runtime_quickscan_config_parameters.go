...
// PutRuntimeQuickscanConfigParams contains all the bound params for the put runtime quickscan config operation
...
func (o *PutRuntimeQuickscanConfigParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.RuntimeQuickScanConfig
