...
//go:generate $GOPATH/bin/mockgen -destination=./mock_resource_table.go -package=database github.com/sambetts-cisco/kubeclarity/backend/v2/pkg/database ResourceTable
